...
public class EnkelLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "DEF", "WITH", "START", "END", "IF", "THEN", "NEW", "RESULT", 
			"READ", "WRITE", "DO", "TO", "GIVE", "OR", "ELSE", "HOIST", "LOOP", "STOP", 
			"FOR", "EACH", "IN", "WHILE", "TYPENUMBER", "TYPESTRING", "TYPEBOOL", 
			"IDENT", "NUMBER", "STRING", "BOOL", "ASSIGN", "OP_PLUS", "OP_MINUS", 
			"OP_MULT", "OP_DIV", "EQ", "LEQ", "GEQ", "LESS", "GREATER", "BREAK", 
			"RETURN", "NEWLINE", "WHITESPACE", "COMMENT"
		};
	}
